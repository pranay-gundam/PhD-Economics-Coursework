...
\frac{p_w^2}{p_g^2} &= 0.
\end{align*} Setting a numeraire of $p_g = 1$ we get that $p_w = 1$. Putting everything together, we can finally classify the competitive equilibrium as $$\boxed{Z_A = (0,1),\,Z_B = (0, 0),\, H_1 = H_2 = (0, 0),\, p_g = 1,\, p_w = 0.}$$
We can get the whole set of equilibria by shifting the numeraire.
\end{solution}
\end{enumerate}
